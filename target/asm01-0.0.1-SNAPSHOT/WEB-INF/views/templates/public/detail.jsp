...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/user/assets/css/custom-bs.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/user/assets/css/jquery.fancybox.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/user/assets/css/bootstrap-select.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/user/assets/fonts/icomoon/style.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/user/assets/fonts/line-icons/style.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/user/assets/css/owl.carousel.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/user/assets/css/animate.min.css">

    <!-- MAIN CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/user/assets/css/style.css">
            ...
            <ul class="comment-list">
                ...
                <li class="comment">
                  ...
                  <div class="comment-body">
                    <h3></h3>
                    <div class="meta" style="color: #373b3e !important;" th:text="${donation.status}"></div>
                    <p></p>
                  </div>
                </li>
        ...
        <div class="col-lg-6">
          <div class="bg-light p-3 border rounded mb-4">
            ...
            <ul class="list-unstyled pl-3 mb-0">
              <li class="mb-2"><strong class="text-black" name="code">Mã đợt quyên góp:</strong>${donation.code} </li>
              <li class="mb-2"><strong class="text-black">Tên đợt quyên góp:</strong>${donation.name}</li>
              <li class="mb-2"><strong class="text-black">Ngày bắt đầu:</strong>${donation.dStart}</li>
              <li class="mb-2"><strong class="text-black">Ngày kết thúc:</strong>${donation.dEnd} </li>
              <li class="mb-2"><strong class="text-black">Cá nhân/Tổ chức:</strong>${donation.dOrg}</li>
              <li class="mb-2"><strong class="text-black">Số điện thoại: </strong>${donation.phonenum}</li>
              <li class="mb-2"><strong class="text-black">Tổng tiền quyên góp nhận được:</strong>${sumMoney}</li>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form method="post" action="/donation/add">
