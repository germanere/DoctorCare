...
<body class="sb-nav-fixed">
	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		<nav th:fragment="html_nav"
			...
			<!-- Navbar Brand-->
			<a class="navbar-brand ps-3" href="/PRJ321_ASM01_4.0/admin">QUẢN
				TRỊ</a>
			<!-- Sidebar Toggle-->
	...
	<div id="layoutSidenav">
		<div id="layoutSidenav_nav">
			<div fragment="html_menu" id="layoutSidenav_nav">
				<nav class="sb-sidenav accordion sb-sidenav-dark"
					...
					<div class="sb-sidenav-menu">
						<div class="nav">
							...
							</a> <a class="nav-link" href="${pageContext.request.contextPath}/admin/donation">
								<div class="sb-nav-link-icon">
									<i class="fas fa-tachometer-alt"></i>
												...
												<div class="row">
													<div class="col-6">
														<label for="addname" class="col-form-label">Số
															...
															id="addname" name="phone" required>
													</div>
													<div class="col-6">
								...
								<tbody>
									...
									<c:forEach var="us1" items="${users}">
										<tr>
											...
											<td>${us1.address}</td>
											<td>${us1.username}</td>
											<td>${us1.role.role_name}</td>
											<!-- Kiểm tra status = 0 hay 1 để hiển thị đúng trạng thái -->
											<c:choose>
												<c:when test="${us1.status == 0}">
													<td style="color: #1c7430; font-weight: bold">Hoạt
														động</td>
												</c:when>
												<c:when test="${us1.status == 1}">
											...
											<td style="width: 270px">
												<button type="button" style="width: 80px"
													...
													data-bs-target="#idModelMail${us1.id}">Gửi</button>

												<button type="button" style="width: 80px"
													class="btn btn-primary" data-bs-toggle="modal"
													data-bs-target="#exampleModal${us1.id}">Sửa
												</button>

												<button type="button" style="width: 80px"
													class="btn btn-warning" data-bs-toggle="modal"
													data-bs-target="idModelDetail${us1.id}">
													Chi tiết</button>

												<button type="button" action="deleteuser"
													style="width: 80px" class="btn btn-danger mt-1"
													data-bs-toggle="modal"
													data-bs-target="#idModalDel${us1.id}">Xóa</button>

												<form action="lockuser" method="post"
													style="margin-left: 85px; margin-top: -38px">
													 <c:if test="${us1.status == 0}">													
													 <input type="hidden" class="form-control" id="id"
														name="idUser" value="${us1.id}">
												...
												<div class="modal fade" id="idModalDel${us1.id}" 	
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-body">
																Người dùng : <span>${us1.fullname}</span>
												...
												<div class="modal fade" id="idModelMail${us1.id}"
													tabindex="-1" aria-labelledby="exampleModalLabel"
													aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<h5 class="modal-title" id="exampleModalLabel">
																	Gửi đến: <span text="${us1.email}"></span>
																</h5>
																<button type="button" class="btn-close"
																	data-bs-dismiss="modal" aria-label="Close"></button>
															</div>
															<div class="modal-body">
																<form action="@{/ql-user/send-mail}" method="post">
																	<input type="hidden" class="form-control" id="id"
																		name="idUser" value="${us1.id}"> <label
												...
												<div class="modal fade" id="idModelDetail${us1.id}"
													tabindex="-1" aria-labelledby="exampleModalLabel"
													aria-hidden="true">
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h5 class="modal-title" id="exampleModalLabel">
																	Chi tiết : <span> ${us1.fullname}</span>
																</h5>
																<button type="button" class="btn-close"
																	data-bs-dismiss="modal" aria-label="Close"></button>
															</div>
										...
										<!-- Modal Update-->
										<div class="modal fade" id="exampleModal${us1.id}"
											tabindex="-1" aria-labelledby="exampleModalLabel"
											aria-hidden="true">
											<div class="modal-dialog modal-lg ">
												<div class="modal-content">
													...
													<div class="modal-body">
														<form action="updateuser" method="post">
															<input type="hidden" name="idUser" value="${us1.id}">
															<div class="row">
																<div class="col-6">
															...
															<div class="row">
																...
																<div class="col-6">
																	<label for="ct_id" class="col-form-label">Vai
																		trò:</label> 
																		<select name="idRole" class="form-control" id="ct_id" required>
